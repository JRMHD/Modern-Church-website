...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($("body").attr("data-scrolldistance")) {
            var $scrolldistance =
                $("body").attr("data-scrolldistance") != ""
                    ? $("body").attr("data-scrolldistance")
                    : 50;
            var $scrolltime =
                $("body").attr("data-scrolltime") != ""
                    ? $("body").attr("data-scrolltime")
                    : 2000;
            var $scrollanimation =
                $("body").attr("data-scrollanimation") != ""
                    ? $("body").attr("data-scrollanimation")
                    : "";
        ...
        if (css_out != "") {
            $("head").append(
                '<style id="theme-dynamic-styles">' + css_out + "</style>"
            );
        }
        /* Full search toggle */
        ...
        /*Responsive Check*/
        var res_from = $("body").attr("data-res-from")
            ? $("body").attr("data-res-from")
            : 768;
        ...
        $(document).on(
            "click",
            ".overlay-search-switch, .overlay-search-close",
            function () {
        ...
        if ($(".full-view-switch").length) {
            var srch_height = $(".full-view-switch")
                .parents(".navbar, .logobar")
                .height();
            $(
                ".full-view-wrapper .navbar-form.search-form .input-group > .form-control"
            ).css("height", srch_height);
            $(document).on(
                "click",
                ".full-view-switch, .full-view-close",
                function () {
        ...
        $(document).on(
            "click",
            ".push-menu-switch, .push-menu-close",
            function () {
                if (
                    $(
                        ".sticky-nav-wrapper.left-push, .sticky-nav-wrapper.right-push"
                    ).length
                ) {
        ...
        $(document).on(
            "click",
            ".push-overlay-menu-switch, .push-overlay-menu-close",
            function () {
                if (
                    $(
                        ".sticky-nav-wrapper.left-overlay, .sticky-nav-wrapper.right-overlay"
                    ).length
                ) {
        ...
        $(document).on(
            "click",
            ".overlay-menu-switch, .overlay-menu-close",
            function () {
        ...
        if ($(".zmm-wrapper").length) {
            ...
            $(document).on("click", "a.zmm-toggle", function () {
                $(".zmm-wrapper").animate(
                    { left: "0" },
                    { duration: 800, specialEasing: { left: "easeInOutExpo" } }
                );
            ...
            $(".navbar-main")
                .clone()
                .appendTo(".zmm-wrapper .zmm-inner .zmm-main-nav");
            $(".zmm-main-nav .navbar-main")
                .removeClass("theme-main-menu")
                .addClass("theme-mobile-menu");

            //Add toggle dropdown icon
            $(".zmm-wrapper .zmm-inner")
                .find(".dropdown, .mega-dropdown-col")
                .append('<span class="zmm-dropdown-toggle ti-plus"></span>');
            $(".zmm-wrapper .zmm-inner")
                .find(".dropdown-menu, .mega-dropdown-child")
                .addClass("sub-nav");

            //Remove unwanted class names in zmm-wrapper
            $(".zmm-wrapper .zmm-inner")
                .find(
                    ".nav, .navbar-nav, .dropdown, .dropdown-menu, .mega-dropdown, .mega-dropdown-menu, .mega-dropdown-child, .active, .dropdown-col-4, .dropdown-col-2, .dropdown-col-3, .dropdown-col-5, .mega-dropdown-col, .mega-dropdown-small, .basic-container, .mega-dropdown-medium, .clearfix"
                )
                .removeClass(
                    "dropdown dropdown-menu container mega-dropdown mega-dropdown-menu mega-dropdown-child active nav navbar-nav dropdown-col-4 dropdown-col-2 dropdown-col-3 dropdown-col-5 mega-dropdown-col clearfix mega-dropdown-small mega-dropdown-medium basic-container"
                );
            ...
            //zmm dropdown toggle
            $(".zmm-wrapper .zmm-inner .zmm-dropdown-toggle").on(
                "click",
                function () {
                    var cur_ele = $(this);
        ...
        /*Push Overlay Menu*/
        $(".push-overlay-menu-switch, .push-overlay-menu-close").click(
            function () {
                if (
                    $(
                        ".sticky-nav-wrapper.left-overlay, .sticky-nav-wrapper.right-overlay"
        ...
        if ($(".pie-chart").length) {
            $(".pie-chart").each(function () {
                ...
                var chart_zorobegining = c_chart.attr("data-yaxes-zorobegining")
                    ? c_chart.attr("data-yaxes-zorobegining")
                    : 0;
        ...
        if ($(".bar-chart").length) {
            $(".bar-chart").each(function () {
                ...
                var chart_responsive = c_chart.attr("data-responsive");
                var chart_legend = c_chart.attr("data-legend-position");
                var chart_zorobegining = c_chart.attr(
                    "data-yaxes-zorobegining"
                );
        ...
        if ($(".line-chart").length) {
            $(".line-chart").each(function () {
                ...
                chart_zorobegining = chart_zorobegining
                    ? chart_zorobegining
                    : 1;
        ...
        if ($(".raindrops").length) {
            $(".raindrops").each(function () {
                var cur = $(this);
                var rain_height = cur.attr("data-rain-height")
                    ? cur.attr("data-rain-height")
                    : 100;
                var rain_color = cur.attr("data-rain-color")
                    ? cur.attr("data-rain-color")
                    : 100;
                cur.raindrops({
                    color: rain_color,
            ...
            $(".popup-gallery").magnificPopup({
                ...
                image: {
                    ...
                    titleSrc: function (item) {
                        var author_name = item.el.attr("data-author-name")
                            ? item.el.attr("data-author-name")
                            : "";
                        return (
                            item.el.attr("title") +
                            "<small>" +
        ...
        if (
            $(
                ".popup-youtube, .popup-vimeo, .popup-gmaps, .popup-video, .popup-audio"
            ).length
        ) {
            $(
                ".popup-youtube, .popup-vimeo, .popup-gmaps, .popup-video, .popup-audio"
        ...
        if ($(".constellation").length) {
            $(".constellation").each(function () {
                ...
                var distance = cur_ele.attr("data-distance")
                    ? cur_ele.attr("data-distance")
                    : "";
                var len = cur_ele.attr("data-length")
                    ? cur_ele.attr("data-length")
                    : "";
                var rad = cur_ele.attr("data-radius")
                    ? cur_ele.attr("data-radius")
                    : "";
                var clr = cur_ele.attr("data-color")
                    ? cur_ele.attr("data-color")
                    : "";
        ...
        if ($(".typing-text").length) {
            $(".typing-text").each(function (i) {
                ...
                if (typing_text) {
                    ...
                    var type_speed = cur_ele.attr("data-typespeed")
                        ? cur_ele.attr("data-typespeed")
                        : 0;
                    var back_speed = cur_ele.attr("data-backspeed")
                        ? cur_ele.attr("data-backspeed")
                        : 0;
                    var back_delay = cur_ele.attr("data-backdelay")
                        ? cur_ele.attr("data-backdelay")
                        : 500;
                    var start_delay = cur_ele.attr("data-startdelay")
                        ? cur_ele.attr("data-startdelay")
                        : 1000;
                    var loop = cur_ele.attr("data-loop")
                        ? cur_ele.attr("data-loop")
                        : false;
        ...
        if ($(".range-slider").length) {
            ...
            $(".range-slider")
                .next(".rangeslider")
                .prepend(
                    '<div class="rangeslider__parts"><div class="rangeslider__parts__part"></div><div class="rangeslider__parts__part"></div><div class="rangeslider__parts__part"></div></div>'
                );
            $(".range-slider")
                .next(".rangeslider")
                .find(".rangeslider__handle")
                .append(
                    '<div class="rangeslider__tooltip__value"><span>$</span> <span class="range-value">' +
                        def_value +
                        "</span><div>Transaction</div></div>"
                );
            range_ele = $(".range-slider")
                .next(".rangeslider")
                .find(".range-value");
        }
    ...
    $window.on("load", function () {
        ...
        if ($(".isotope-grid").length) {
            $(".isotope-grid").each(function (index) {
                ...
                var portfolio_filter = cur_portfolio
                    .parent(".portfolio-wrap")
                    .children(".portfolio-filter");
                var filter = $(portfolio_filter).attr("data-first-cat")
                    ? "." + $(portfolio_filter).attr("data-first-cat")
                    : "*";
        ...
        var o_stat = 0;
        $(
            ".theme-main-menu li.menu-item, .theme-mobile-menu li.menu-item"
        ).each(function (index) {
            var cur_item = this;
        ...
        if (o_stat) {
            if (
                $(".theme-main-menu .menu-item").find('a[href="#section-top"]')
                    .length
            ) {
            ...
            if (win_width >= res_from) {
                hght_ele = $("body").attr("data-scroll-offset")
                    ? $("body").attr("data-scroll-offset")
                    : 50;
            } else {
                hght_ele = $("body").attr("data-scroll-moffset")
                    ? $("body").attr("data-scroll-moffset")
                    : 50;
            }
            ...
            //Animate Scroll Code
            $(
                '.theme-main-menu .menu-item > a[href^="#section-"], .theme-mobile-menu .menu-item > a[href^="#section-"]'
            ).on("click", function (e) {
                var cur_item = this;
        ...
        if ($(".day-counter").length) {
            $(".day-counter").each(function (index) {
                ...
                var data_size = day_counter.attr("data-size")
                    ? day_counter.attr("data-size")
                    : 100;
                var data_thick = day_counter.attr("data-thick")
                    ? day_counter.attr("data-thick")
                    : 0;
                var data_empty_clr = day_counter.attr("data-empty-color")
                    ? day_counter.attr("data-empty-color")
                    : "transparent";
                var data_fill_clr = day_counter.attr("data-fill-color")
                    ? day_counter.attr("data-fill-color")
                    : "transparent";
        ...
        if ($(".progress-bar").length) {
            ...
            $(".progress .progress-bar").appear(function () {
                ...
                if (prgrs.attr("data-scolor")) {
                    ...
                    var empty_color = prgrs.attr("data-empty")
                        ? prgrs.attr("data-empty")
                        : "#f1f1f1";
                    var scolor = prgrs.attr("data-scolor")
                        ? prgrs.attr("data-scolor")
                        : "#333333";
                    var ecolor = prgrs.attr("data-ecolor")
                        ? prgrs.attr("data-ecolor")
                        : "#333333";
                ...
                prgrs
                    .delay(itv)
                    .animate({ width: prgrs_val }, 3000, "easeInOutExpo");
    ...
    function compare_payment(cp_obj, range_value) {
        ...
        cp_obj.each(function (index) {
            ...
            var t = parseFloat(
                (range_value / 100) * cp_child_json.trans_fee +
                    parseFloat(cp_child_json.additional_fee)
            ).toFixed(2);
            var cp_trans =
                cp_child_json.min_trans_fee < t
                    ? t
                    : compare_json.stripe_arr[2];
            ...
            if (cp_child_json.compare_trans == "yes") {
                $.each(cheap_arr, function (index, cvalue) {
                    cheap_cal =
                        cheap_cal +
                        '<p class="alert-success">We are ' +
                        parseFloat(cvalue / cp_trans).toFixed(2) +
                        "% cheaper! than " +
                        cheap_txt[index] +
                        "</p>";
                });
    ...
    function zoacresDayCircle(ele, value, chk, indx) {
        ...
        c_circle.circleProgress({
            ...
            fill: {
                gradient: [
                    daycount_obj[indx].data_fill_clr,
                    daycount_obj[indx].data_fill_clr,
                ],
            },
        });
    ...
    function zoacresSetCustomBgColor() {
        $(".bg-custom-color").each(function (index) {
            ...
            if (cur_item.attr("data-bg-end-color")) {
                ...
                var gradient_deg = cur_item.attr("data-bg-deg")
                    ? cur_item.attr("data-bg-deg")
                    : "120deg";
                cur_item.css(
                    "background-image",
                    "linear-gradient(" +
    ...
    function zoacresFooterHidden() {
        if ($window.width() > 991) {
            $(".page-wrapper-inner").css(
                "margin-bottom",
                $(".footer-hidden").outerHeight()
            );
        } else {
